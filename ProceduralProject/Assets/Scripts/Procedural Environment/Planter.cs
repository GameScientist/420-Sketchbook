...
public class Planter : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Instantiate(lavaPrefab, new Vector3(Random.Range(-40f, 80f), 80f, Random.Range(-40f, 80f)), transform.rotation);
        ActivateChunks();
    ...
    {
        Vector3 thresholdOffset = new Vector3(Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f));
        Vector3 zoomOffset = new Vector3(Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f));
        Vector3 flattenAmountOffset = new Vector3(Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f));
        Vector3 flattenOffsetOffset = new Vector3(Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f));
        foreach (ChunkSpawner spawner in spawners)
        {
            Vector3 noisePos = spawner.transform.position - new Vector3(40, 40, 40) / 120;
            print(spawner);
            spawner.SpawnChunk(Mathf.Lerp(0f, 1f, Noise.Perlin(noisePos + thresholdOffset)), new Vector3(Random.Range(0f, 1f), Random.Range(0f, 1f), Random.Range(0f, 1f)), Mathf.Lerp(5f, 50f, Noise.Perlin(noisePos + zoomOffset)), Mathf.Lerp(0f, 1f, Noise.Perlin(noisePos + flattenAmountOffset)), Mathf.Lerp(-50f, 50f, Noise.Perlin(noisePos + flattenOffsetOffset)));
        }
    }
    ...
    {
        Physics.SphereCast(new Vector3(Random.Range(x * 10, (x + 1) * 10), 80, Random.Range(y * 10, (y + 1) * 10)), 1, Vector3.down, out RaycastHit spawnPoint);
    ...
    private void SpawnPlayer()
    {
        ...
        Physics.SphereCast(new Vector3(Random.Range(x * 5, (x + 1) * 5), 80, Random.Range(y * 5, (y + 1) * 5)), 1, Vector3.down, out RaycastHit spawnPos);
